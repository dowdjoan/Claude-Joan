...
export const CAPTIONS: Caption[] = [
  // HOOK
  { from: 0, to: 1.036, lines: ["SOY CHILENO. TENGO"], emphasis: ["CHILENO"] },
  { from: 1.036, to: 2.071, lines: ["29 AÑOS, Y"], emphasis: ["29"] },
  { from: 2.071, to: 3.107, lines: ["NADA, ANTES DE"] },
  { from: 3.107, to: 4.142, lines: ["ENTRAR EN EL"] },
  { from: 4.142, to: 5.178, lines: ["MUNDO DE LOS"] },
  { from: 5.178, to: 6.213, lines: ["NEGOCIOS DIGITALES, ME"] },
  { from: 6.213, to: 7.249, lines: ["DESEMPEÑABA COMO INGENIERO"], emphasis: ["INGENIERO"] },
  { from: 7.249, to: 8.284, lines: ["Y CONSTRUCTOR. INGENIERÍA"], emphasis: ["CONSTRUCTOR"] },
  { from: 8.284, to: 9.32, lines: ["EN CONSTRUCCIÓN, TRABAJABA"] },
  { from: 9.32, to: 10.355, lines: ["COMO CONTRATISTA, ME"] },
  { from: 10.355, to: 11.391, lines: ["CANSÉ DE ESO"] },
  { from: 11.391, to: 12.426, lines: ["Y MUTÉ AL"] },
  { from: 12.426, to: 13.462, lines: ["MUNDO DE LO"] },
  { from: 13.462, to: 14.497, lines: ["QUE ES EL"] },
  { from: 14.497, to: 15.533, lines: ["CLOSING. CLOSING DE"], emphasis: ["CLOSING."] },
  { from: 15.533, to: 16.569, lines: ["VENTAS HIGH TICKET."], emphasis: ["HIGH", "TICKET."] },
  // EL TECHO
  { from: 16.569, to: 17.393, lines: ["TOTAL, TOTAL. UN"] },
  { from: 17.393, to: 18.218, lines: ["PUNTO NÚMERO UNO"] },
  { from: 18.218, to: 19.042, lines: ["POR EL TEMA"] },
  { from: 19.042, to: 19.866, lines: ["DE LA COMISIÓN."] },
  { from: 19.866, to: 20.691, lines: ["POR EJEMPLO, SI"] },
  { from: 20.691, to: 21.515, lines: ["CERRABA UNA DE"] },
  { from: 21.515, to: 22.34, lines: ["2.500, ME DABAN"] },
  { from: 22.34, to: 22.889, lines: ["EL 8%."], emphasis: ["8%."] },
  { from: 22.889, to: 23.713, lines: ["SI CERRABA UNA"] },
  { from: 23.713, to: 24.537, lines: ["DE MENOS DE"] },
  { from: 24.537, to: 25.362, lines: ["1.200, ME DABAN"] },
  { from: 25.362, to: 25.912, lines: ["EL 10%."], emphasis: ["10%."] },
  { from: 25.912, to: 26.736, lines: ["ENTONCES ERA COMO"] },
  { from: 26.736, to: 27.56, lines: ["QUE JUGABAN CON"] },
  { from: 27.56, to: 28.385, lines: ["ESO. NOSOTROS TODOS"] },
  { from: 28.385, to: 29.209, lines: ["TENEMOS 24 HORAS"] },
  { from: 29.209, to: 30.033, lines: ["Y COMO YO"] },
  { from: 30.033, to: 30.858, lines: ["COBRABA POR LO"] },
  { from: 30.858, to: 31.682, lines: ["QUE IBA HACIENDO,"] },
  { from: 31.682, to: 32.506, lines: ["TENÍA CLARAMENTE UN"] },
  { from: 32.506, to: 33.332, lines: ["LÍMITE, UN TECHO."], emphasis: ["TECHO."] },
  // EL SALTO A 30%
  { from: 33.332, to: 33.997, lines: ["SIGO LLEVÁNDOME EL"] },
  { from: 33.997, to: 34.663, lines: ["10 DE CLOSER"], emphasis: ["10"] },
  { from: 34.663, to: 35.328, lines: ["PERO AHORA ME"] },
  { from: 35.328, to: 35.994, lines: ["LLEVO ADEMÁS EL"] },
  { from: 35.994, to: 36.216, lines: ["20%"], emphasis: ["20%"] },
  { from: 36.216, to: 36.881, lines: ["COMO CONSULTOR, O"] },
  { from: 36.881, to: 37.546, lines: ["SEA QUE ME"] },
  { from: 37.546, to: 37.99, lines: ["LLEVO EL"] },
  { from: 37.99, to: 38.212, lines: ["30%"], emphasis: ["30%"] },
  { from: 38.212, to: 38.877, lines: ["POR CIENTO EN"] },
  { from: 38.877, to: 39.099, lines: ["TOTAL."], emphasis: ["TOTAL."] },
  { from: 39.099, to: 39.764, lines: ["O SEA, DE"] },
  { from: 39.764, to: 40.43, lines: ["UN CIERRE DE"] },
  { from: 40.43, to: 40.873, lines: ["MIL DÓLARES,"], emphasis: ["MIL", "DÓLARES,"] },
  { from: 40.873, to: 41.539, lines: ["VOS TE LLEVAS"] },
  { from: 41.539, to: 41.982, lines: ["300 DÓLARES."], emphasis: ["300", "DÓLARES."] },
  { from: 41.982, to: 42.647, lines: ["ME LLEVO, ES"] },
  { from: 42.647, to: 43.313, lines: ["UNA LOCURA, AMIGO,"] },
  { from: 43.313, to: 43.757, lines: ["ME LLEVO"] },
  { from: 43.757, to: 44.2, lines: ["300 DÓLARES."], emphasis: ["300", "DÓLARES."] },
  { from: 44.2, to: 44.865, lines: ["ANTES ME LLEVABA"] },
  { from: 44.865, to: 45.535, lines: ["MENOS DE 100."], emphasis: ["100."] },
  // CUATRO DÍAS
  { from: 45.535, to: 47.678, lines: ["ME ACUERDO PATENTE,"] },
  { from: 47.678, to: 49.821, lines: ["EN CUATRO DÍAS"], emphasis: ["CUATRO", "DÍAS"] },
  { from: 49.821, to: 51.964, lines: ["TUVISTE LA WIN."], emphasis: ["WIN."] },
  { from: 51.964, to: 53.392, lines: ["CUATRO DÍAS,"], emphasis: ["CUATRO", "DÍAS,"] },
  { from: 53.392, to: 54.106, lines: ["LITERAL."] },
  { from: 54.106, to: 55.528, lines: ["CUATRO DÍAS."], emphasis: ["CUATRO", "DÍAS."] },
  // CIERRE
  { from: 55.528, to: 56.097, lines: ["UNA COMPLETA LOCURA,"] },
  { from: 56.097, to: 56.666, lines: ["TOTALMENTE DIFERENTE A"] },
  { from: 56.666, to: 57.235, lines: ["LO QUE ERA"] },
  { from: 57.235, to: 57.425, lines: ["ANTES."] },
  { from: 57.425, to: 57.994, lines: ["TEMA DE DECIR,"] },
  { from: 57.994, to: 58.563, lines: ["NO NECESITO, O"] },
  { from: 58.563, to: 59.132, lines: ["SEA, NO TENGO"] },
  { from: 59.132, to: 59.701, lines: ["MIEDO MÁS DE"] },
  { from: 59.701, to: 60.27, lines: ["QUEDARME SIN TRABAJO,"] },
  { from: 60.27, to: SPEECH_TOTAL, lines: ["ES QUE ES IMPOSIBLE."], emphasis: ["IMPOSIBLE."] },
];
